...
typedef VERB_token_t (*VERB_token_fun_t) (char* restrict* const restrict, VERB_tokeniser_t* const restrict);
...
#define VERB_tokens_MULTI_LINE_COMMENT_START_LEN    2
#define VERB_tokens_MULTI_LINE_COMMENT_END_LEN      2
#define VERB_tokens_SINGLE_LINE_COMMENT_START_LEN   2
#define VERB_tokens_SINGLE_LINE_COMMENT_END_LEN     1
