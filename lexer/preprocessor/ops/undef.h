...
VERB_token_t VERB_preprocessor_op_undef(char* restrict* const restrict string, VERB_tokeniser_t* const restrict tokeniser){
    if(!VERB_preprocessor_op__check_for_whitespace(string, "#undef", tokeniser)) return VERB_TOKEN_special_IGNORE;
// gets length of name
