...
void VERB_preprocessor_op_warning(char* restrict* const restrict string, VERB_tokeniser_t* const restrict tokeniser){
// incorrect formatting
    if(!VERB_preprocessor_op__check_for_whitespace(string, "#warning", tokeniser)) return;
    if(**string != '"'){
