...
// memory stuff
    VERB_BC_dereference,                // pointer dereferencing    | *S -> D
    VERB_BC_set,                        // special bytecode         | S -> D
    VERB_BC_index,                      // array indexing           | S0:S1 -> D
    VERB_BC_reference,                  // address of variable      | &S -> D
// misc.
    VERB_BC_comma,                      // comma operator           | S1 -> D (S0 discarded)
