#ifndef VERB_bytecode_op_token_eof_included
#define VERB_bytecode_op_token_eof_included
...
void VERB_bytecode_op_eof(char* restrict* const restrict string, VERB_tokeniser_t* const restrict tokeniser){
