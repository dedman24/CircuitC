...
void VERB_preprocessor_op_error(char* restrict* const restrict string, VERB_tokeniser_t* const restrict tokeniser){
// incorrect formatting
    if(!VERB_preprocessor_op__check_for_whitespace(string, "#error", tokeniser)) return;
    if(**string != '"'){
