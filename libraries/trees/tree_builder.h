...
\
VERB_tree_##typename##_t* VERB_tree_##typename##_node_make(char* key, const size_t keylen, const type value){                                   \
...
\
void VERB_tree_##typename##_put(VERB_tree_##typename##_t** restrict tree, char* restrict key, const size_t keylen, const type value){           \
    if(!*tree){                                                                                                                                 \
